...
describe("Supabase action store", () => {
  test("refuses a non-canonical Supabase project", () => {
    for (const url of [
      ...
      "https://ibxvxmfhovmththllwoi.attacker.example",
      "https://ibxvxmfhovmththllwoi.supabase.co.attacker.example",
      "https://ibxvxmfhovmththllwoi.supabase.co:8443",
      "https://user@ibxvxmfhovmththllwoi.supabase.co",
  ...
  test("resolves Google and deployed email-session subjects through their canonical identity columns", async () => {
    ...
    const store = createSupabaseActionStore({
      url: "https://ibxvxmfhovmththllwoi.supabase.co",
