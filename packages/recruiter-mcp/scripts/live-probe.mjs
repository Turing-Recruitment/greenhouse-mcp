 ...
 *   GREENHOUSE_RECRUITER_IDENTITY_SUPABASE_URL=https://ibxvxmfhovmththllwoi.supabase.co  # Q5 (runtime identity project REST origin)
 ...
 *   PROBE_ANALYTICS_SUPABASE_URL=https://ilkbfyubwvbpsevybsfe.supabase.co               # Q6 (analytics project REST origin)
 ...
 *   - scripts/greenhouse-mcp-supabase-guard.mjs — canonical ref ibxvxmfhovmththllwoi (Greenhouse MCP),
 *       analytics ref ilkbfyubwvbpsevybsfe (recruiting-ops-analytics).
...
const CANONICAL_SUPABASE_REF = "ibxvxmfhovmththllwoi"; // "Greenhouse MCP" — recruiter identity project
const ANALYTICS_SUPABASE_REF = "ilkbfyubwvbpsevybsfe"; // "recruiting-ops-analytics"
