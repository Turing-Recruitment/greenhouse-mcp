...
export async function streamApplicationsForSnapshot(
  ...
  // the live pipeline only — the unfiltered full-org read hit 1000 pages (500k+ applications) on
  // this tenant and was refused as incomplete rather than written partial.
