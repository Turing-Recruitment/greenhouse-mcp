...
export const GET_RECRUITING_CAPABILITIES_TOOL: RecruiterToolDefinition = {
  ...
  kind: "analysis",
  description:
    "List supported read-only scoped analysis recipes, user modes, and the job-scope-resolution contract. This tool only reads; write actions, where a session is entitled, appear separately as preview_*/apply_* tools.",
};
