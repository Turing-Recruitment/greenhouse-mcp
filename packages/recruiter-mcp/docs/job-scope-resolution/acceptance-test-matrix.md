...
| Exact req ID | recruiter | `requisition_ids: ["SAIS-US-401"]` | `resolved`, confirmed scope, open Senior AI Solutions Engineer |
| Closed job default exclusion | recruiter | `query: "Senior AI Solutions Engineer"` | open job included, closed job excluded, warning or match reason notes default-open filter |
| Include closed | recruiter | `query: "Senior AI Solutions Engineer", status: ["open","closed"]` | needs confirmation because open and closed matches exist |
