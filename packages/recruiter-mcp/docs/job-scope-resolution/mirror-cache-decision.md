...
The documented Greenhouse MCP Supabase project is `Greenhouse MCP` (`ibxvxmfhovmththllwoi`), and current usage is identity/session revocation only. No mirror/cache storage ownership is accepted or introduced here.
