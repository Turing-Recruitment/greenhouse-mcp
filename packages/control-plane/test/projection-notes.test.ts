...
const RAW_NOTE_WITH_PII = Object.freeze({
  ...
  cc: ["recruiter@turing.com"],
  bcc: ["archive@turing.com"],
  from: "sourcer@turing.com",
  user: {
    id: 42,
    name: "Jane Recruiter",
    email: "jane.recruiter@turing.com",
  },
...
describe("projectNote — §4 exclusion rule (contract tests)", () => {
  ...
  it("candidate names, emails, and free-text prose in body/subject never appear in the serialized projection", () => {
    ...
    const forbiddenSubstrings = [
      ...
      "recruiter@turing.com",
      "jane.recruiter@turing.com",
      "linkedin.com",
      "RE: Jane",
      "availability",
      "confirmed",
